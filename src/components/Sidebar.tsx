          ...
          <AnimatePresence mode="wait">
            {/* {!isCollapsed && ( */}
              <>
                ...
                >
                  <h2 className="text-lg font-bold text-gray-900 dark:text-white">Empresa</h2>
                  <p className="text-xs text-gray-600 dark:text-gray-400 w-40 text-center mx-auto">Descripcion empresa</p>
                </motion.div>
              </>
            {/* )} */}
          </AnimatePresence>
