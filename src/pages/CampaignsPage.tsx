...
export default function CampaignsPage() {
    ...
    return (
        ...
        >
            <AnimatePresence>
                {createNewCampaign ? <CampaignForm setCreateNewCampaign={setCreateNewCampaign}/> :
                    <CampaignList campaigns={allCampaigns} setCreateNewCampaign={setCreateNewCampaign}/>}
            </AnimatePresence>
        </div>
    );
}
            ...
            >
                ...
                <div className="flex items-center justify-center space-x-2">
                    <motion.button whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                        ...
                        <ChevronLeft className="w-6.5 h-6.5"/></motion.button>
                        ...
                        {phoneNumbers.length > 0 && (
                            <Tooltip delayDuration={500}>
                                ...
                                <TooltipContent side='bottom'>
                                    <p className='max-w-xs'>Envia un mensaje de WhatsApp a todos los numeros de telefono
                                        de los clientes seleccionados para validar si el numero es valido y/o esta en
                                        uso, segun la respuesta del cliente se actualizara el estado.</p>
                                </TooltipContent>
                            </Tooltip>
                        )}
                    </AnimatePresence>
                ...
                {openFileForm &&
                    <PhoneNumberFileForm isOpen={openFileForm} onClose={() => setOpenFileForm(false)}
                                         onSubmit={handleCreatePhoneNumberByFile} isLoading={isLoading}/>}
                {isFormOpen &&
                    <PhoneNumberForm
                        isOpen={isFormOpen}
                        onClose={closeForm}
...
function CampaignList({campaigns, setCreateNewCampaign}: {
