import {ElementType, useState, ReactNode, Dispatch, SetStateAction} from "react";
...
export default function DataTableComponent<T extends Record<string, unknown>>({
    ...
    return (
        <div
            className="overflow-x-auto rounded-xl shadow-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800">
            <table className="min-w-full rounded-xl overflow-hidden">
                <thead
                    className="bg-gradient-to-r from-blue-100 via-blue-50 to-blue-200 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800">
                <tr>
                    {
                        headers.length === 0 ? (
                                ...
                                >
                                    <div className="flex justify-end space-x-2">
                                        <button
                                            ...
                                            onClick={() => setPage && setPage((prev) => (prev || 1) - 1)}
                                        >
                                            Previous
                                        </button>
                                        <button
