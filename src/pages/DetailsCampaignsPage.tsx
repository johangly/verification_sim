          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Estas campañas se utilizan para enviar mensajes de confirmación
                a los clientes.
              </p>
            </motion.div>
              ...
              <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900 dark:text-white">
                      {selectedCampaign.templateUsed || "Sin plantilla"}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900 dark:text-white">
                      {selectedCampaign.createdByUser === 1
                        ? "Admin"
                        : "Usuario"}
                    </p>
                  </div>
        ...
        <div className="space-y-3 mt-4">
          <div>
            ...
            <p className="text-sm text-gray-900 dark:text-white truncate">
              {campaign.templateUsed || "Sin plantilla"}
            </p>
          </div>
          {/*<div>
...
function ListView({
  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-50 dark:bg-gray-700/50 px-6 py-2 border-t border-gray-200 dark:border-gray-700">
        <div className="flex justify-between items-center">
          <span className="text-xs text-gray-500 dark:text-gray-400">
            ID: {campaign.id}
          </span>
